...
pub(crate) struct WindowState {
    ...
    /// Whether this window is embedded into a host-provided parent window
    /// (e.g. an audio plugin editor). Used to avoid DPI-awareness changes
...
impl WindowState {
    pub fn new(
        ...
        user32: ExtendedUser32, parented: bool,
    ) -> Self {
        Self {
            hwnd,
    ...
    pub fn resize(&self, size: Size) {
        ...
        self.hwnd
            .resize_and_activate(new_size, dpi, &self.user32, self.parented)
            .unwrap();
    }
